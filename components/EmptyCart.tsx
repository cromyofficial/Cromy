  ...
  return (
    ...
    flex items-center justify-center p-4">
      ...
      >
        ...
        <Link
          href={"/"}
          className="block bg-[#151515]/5 border border-[#151515]/20 text-center 
          py-2.5 rounded-full text-sm font-semibold tracking-wide hover:border-[#151515] 
          hover:bg-[#151515] hover:text-white hoverEffect"
        >
          Discover Products
        </Link>
      </motion.div>
