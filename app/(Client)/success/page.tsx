...
useEffect(() => {
  // Only reset cart if we have orderNumber or sessionId
  if (!orderNumber && !sessionId) {
    // Optional: comment this line while testing
    // router.push("/");
    console.warn("No orderNumber or sessionId found, redirect skipped for testing.");
  } else {
    resetCart();
  }
