...
<section>
  <p>{`
This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.cromy.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
`}</p>
</section>

<section>
  <p>{`
The Platform is owned by SHAN ENTERPRISES, a company incorporated under the Companies Act, 1956 with its registered office at KHASRA NO 10, KABIR NAGAR, DELHI, Delhi, Delhi,110094 (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
`}</p>
</section>
...
<section>
  ...
  <p>{`Estimated Shipping Delivery time is 2-7 days`}</p>
</section>

<section>
  <h2 className="text-xl font-semibold mb-2">Return and Refund Policy</h2>
  <p>{`*No Return/Refund/Exchange are Entertained*`}</p>
</section>
